...
describe('TimelineComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      comp.ngOnChanges({
        start_date: new SimpleChange(null, comp.start_date, true),
        end_date: new SimpleChange(null, comp.end_date, true),
        inputData: new SimpleChange(null, comp.inputData, true)
      });
    });
  }));
